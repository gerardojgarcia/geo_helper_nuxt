...
<template>
  <div class="grid py-16 place-items-center">
    ...
    <div class="image-uploader">
      ...
      <button
        @click="uploadImage"
        class="image-uploader-btn border-2 duration-100 border-black text-black p-3 rounded-sm text-white"
      >
        Upload Image
      </button>
    ...
    <div class="flex flex-col">
      ...
      <div class="carousel overflow-hidden w-3/4">
        <div
        ...
        <div class="carousel-buttons space-x-8 py-8">
          <button
            class="image-uploader-btn border-2 duration-100 border-black text-black p-4 w-32 rounded-sm cursor-pointer hover:shadow-xl"
            @click="prevImage"
          ...
          <button
            class="image-uploader-btn border-2 duration-100 border-black text-black p-4 w-32 rounded-sm cursor-pointer"
            @click="nextImage"
